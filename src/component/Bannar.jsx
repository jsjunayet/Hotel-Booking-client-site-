    ...
    return (
        <div className="hero">
            <div className="hero-content flex-col gap-10 lg:flex-row">
                ...
                <div className='lg:w-1/2 w-full  space-y-6 p-5 mt-20 lg:mt-0'>
                    <h2 className='text-3xl font-semibold mt-20 lg:mt-0'>Subscribe to Our Newsletter</h2>
                    ...
                    <div>
                        ...
                        <button className='btn btn-outline btn-secondary lg:ml-10 ml-0'>Subscribe</button>
